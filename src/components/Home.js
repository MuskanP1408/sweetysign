...
function CounterCard({ title, initialValue, limit }) {
  ...
  return (
    <center><MDBCard className="text-center mb-4 custom-card" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', color: 'white' }}>
        ...
        <div className="mask" style={{ backgroundColor: 'rgba(0, 0, 0, 0.8)' }}>
          <div className="d-flex justify-content-center align-items-center h-100">
            <MDBContainer>
              ...
              {/* Cards Section */}
        <MDBContainer className='cardSection'>
        ...
        <MDBContainer>
          <MDBContainer>
            <MDBRow>
              ...
              <MDBCol sm="12" md="4">
                <CounterCard title="Project Completed" initialValue={0} limit={150} />
              </MDBCol>
              <MDBCol sm="12" md="4">
                <CounterCard title="Happy Clients" initialValue={0} limit={500} />
              </MDBCol>
            </MDBRow>
          </MDBContainer>
        </MDBContainer> */}
